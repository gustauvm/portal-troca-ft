  ...
  return (
    ...
    >
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <Card>
            <CardHeader>
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  ...
                  <CardDescription>
                    {request.requestType === "swap" ? "Permuta" : "FT"}
            ...
            <CardContent className="grid gap-4">
              ...
              <div className="rounded-[28px] border border-black/6 bg-white/75 p-5">
                <p className="text-sm font-semibold text-[color:var(--ink-950)]">Motivo</p>
                <p className="mt-2 text-sm leading-7 text-[color:var(--ink-700)]">{request.reason}</p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid gap-6">
          <ReviewActions requestId={request.id} canReview={canReview} />
        </div>
      </div>
    </OperatorShell>
  );
